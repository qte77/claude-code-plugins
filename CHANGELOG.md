...
- **`.claude/rules/core-principles.md`**: Tightened 73 → 54 lines — kept acronym expansions (KISS, DRY, AHA, YAGNI) and added failure-mode glosses where the name alone wasn't self-evident; folded "User-Centric Principles" into the intro; merged four overlapping Execution entries (Concise/Reuse/Prevent/Resolve) into "Match existing patterns; ask before diverging"; preserved Rigor-and-Sufficiency, High-Impact-Quick-Wins, Clarity, Actionable-and-Concrete, and Root-Cause-and-First-Principles. workspace-setup 1.3.11 → 1.3.12, workspace-sandbox 1.3.10 → 1.3.11.
